...
```sh
$ git clone https://github.com/alexander-lee/dotfiles.git ~/dotfiles
$ cd ~/dotfiles
$ chmod +x setup.sh
$ ./setup.sh
```
...
```sh
sh -c "`curl -fsSL https://raw.github.com/alexander-lee/dotfiles/master/remote-setup.sh`"
```

Or, using wget:

```sh
sh -c "`wget -O - --no-check-certificate https://raw.githubusercontent.com/alexander-lee/dotfiles/master/remote-setup.sh`"
```
